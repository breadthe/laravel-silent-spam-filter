...
class LaravelSilentSpamFilterServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
        ...
        if ($this->app->runningInConsole()) {
            $this->publishes([
                __DIR__.'/../config/config.php' => config_path('laravel-silent-spam-filter.php'),
            ], 'config');
    ...
    public function register()
    {
        ...
        $this->mergeConfigFrom(__DIR__.'/../config/config.php', 'laravel-silent-spam-filter');

        // Register the main class to use with the facade
        $this->app->singleton('laravel-silent-spam-filter', function () {
            return new LaravelSilentSpamFilter;
        });
    }
}
